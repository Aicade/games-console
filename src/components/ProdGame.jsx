...
const ProdGame = () => {
  ...
  useEffect(() => {
    ...
    const gatherCode = async () => {
      ...
      const sdkUrl = `${base}lib/braincadeSDK.js`;
      const vfxUrl = `${base}lib/vfxLibrary.js`;
      const gameUrl = `${base}games/${name}`;
      const assetsUrl = `${base}assetsList.js`;
      const soundsUrl = `${base}soundsList.js`;
  ...
  return (
    <div className="">
      <div className="">
        <div>
          <div
            className="relative h-[95vh] m-1 border-solid border-black border-2 bg-black text-white"
            id="game-container"
          >
